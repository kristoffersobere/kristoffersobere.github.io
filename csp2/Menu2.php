              ...
              $setimg = substr($img,6);
							...
							echo "<div class='well col-md-4'>";
								...
								echo "<form method='POST' action='addtocart.php?index=$id&checkin=$datein&checkout=$dateout'>";
									echo "<img src='".$setimg."' width='200px' height='200px'><br><br>";
				...
				$dateout = $_GET['checkout'];
                  ...
                  if (isset($_SESSION['cart'])) {
                    ...
                    foreach ($qtty as $index => $q) {
                            ...
                            echo "<div class='col-xs-12 well item_display'><form action='cart_qty_change.php?index=$index&checkin=$datein&checkout=$dateout' method='POST'><img src='$sett' class='img-rounded'><br>";
                            echo "Name: ".$name."<br>";
